...
train_set, test_set = load_conll2003(path = "../../Dataset/CoNLL2003/", options = "ner")
...
print("Recall:", recall)
print("HMC Down F1 NER CoNLL2003:", f1, "\n")

kw_precision = kw_gold/kw_detected
kw_recall = kw_gold/kw_true
kw_f1 = 2 * kw_precision * kw_recall / (kw_precision + kw_recall)

print("Results for Known Words:")
print("Precision:", kw_precision)
print("Recall:", kw_recall)
print("F1:", kw_f1, "\n")

uw_precision = uw_gold/uw_detected
uw_recall = uw_gold/uw_true
uw_f1 = 2 * uw_precision * uw_recall / (uw_precision + uw_recall)

print("Results for Unknown Words:")
